...
def staging():
    ...
    env.project_root = '<project_root>/jogaora_app'
    env.GIT_REPO = 'git@github.com:<git_user>/jogaora_app.git'
    env.APPS = [] # put your apps here that should tests run before deploy
    env.SETTINGS_LOCAL = 'jogaora_app.settings_local' 
